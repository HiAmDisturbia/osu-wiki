...
La page d'information de la beatmap sur le site web calcule la longueur de drain (étiqueté `Drain length`) en se basant uniquement sur les début des objets, donc si le dernier objet de la beatmap est un [slider](/wiki/Gameplay/Hit_object/Slider) ou un [spinner](/wiki/Gameplay/Hit_object/Spinner), la longueur de drain sera affichée de manière incorrecte.
